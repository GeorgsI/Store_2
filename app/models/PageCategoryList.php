...
class PageCategoryList extends Model{
    function execute($action, $parameters)
    {
        ...
        //$goods = "SELECT goods.id_goods, goods.title_goods, goods.code, goods.YN, goods.priceRose, goods.promoPrise, goods.infoAdd, goods.accessSale_idaccessSale, goods.brends_id_brends, goods.category_id_category, goods.photo, goods.rating, goods.description FROM goods WHERE goods.category_id_category = :goods";
        ...
        $arguments = ['goods'=> $parameters[2]['num']]; 
